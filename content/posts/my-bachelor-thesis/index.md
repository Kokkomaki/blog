...
*Figure 1.* The temporal (left) and contemporaneous (right) network models.

![](/images/my-bachelor-thesis-55aoi4b4.jpg)

*Note.* Depression (Ftr. and Anh.), anxiety (Nrv. and Wrr.), and stress (Rlx. and Irr.). Red indicates negative association and blue positive association. The thicker and more saturated the edge, the stronger the association. Only significant edges are shown (α = .05).
...
*Table 1.* Ecological momentary assessment items queried 4 times per day for 15 days.

![](/images/my-bachelor-thesis-slyhca5m.jpg)

*Note:* Item options were: 1 = Not at all, 2 = Slightly, 3 = Moderately, 4 = Very, 5 = Extremely.
...
Full code and syntax is available online, as well as full data, excluding the data we erased to guarantee anonymity (see [https://osf.io/n4xw6/?view_only=7740db5988d149bb9020f72841b73891](https://osf.io/n4xw6/?view_only=7740db5988d149bb9020f72841b73891)).
